...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V = list()
  V[["noFish"]]  = asc_noFish
  V[["fish"]]  = asc_fish + b_weekend_holiday * weekendHoliday + b_shoulder * shoulder + 
    b_peakSummer * peakSummer + b_age * age + b_age_weekend * age_weekend

  #+ 
    # b_month_Feb * month_Feb + b_month_Mar * month_Mar + 
    #  b_month_Apr * month_Apr + b_month_May + month_May + b_month_Jun + month_Jun + b_month_Jul + month_Jul +
    #  b_month_Aug * month_Aug + b_month_Sep * month_Sep + b_month_Oct * month_Oct + b_month_Dec * month_Dec 
  #+
   #b_age * age + b_weekend_holiday * weekendHoliday + b_age_weekend * age_weekend
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V = list()
  V[["noFish"]] = asc_noFish 
  #+ b_shoulder * shoulder + b_peakSummer * peakSummer
  V[["river"]] = asc_river_value + b_weekend_holiday * weekendHoliday
  V[["greatLake"]] = asc_greatLake_value + b_weekend_holiday * weekendHoliday
  V[["inlandLake"]] = asc_inland + b_weekend_holiday * weekendHoliday
...
```
Hm. That didn't work. The data might just be too unbalanced since the vast majority of days are 'noFish'

Separate models? First logit for fishing or no, then filter to fishing days only to predict waterbody type?